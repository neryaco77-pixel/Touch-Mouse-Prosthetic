        ...
        children: [
          ...
          Expanded(
            child: Padding(
              ...
              child: Row(
                children: [
                  // --- משטח תנועה (Move Area) עם דאבל קליק ימני ---
                  Expanded(
                    flex: 5,
                    child: GestureDetector(
                      behavior: HitTestBehavior.opaque,

                      // 1. קליק בודד -> קליק שמאלי
                      onTap: () {
                        print("👆 Single Tap -> Left Click");
                        _leftClick();
                      },

                      // 2. דאבל קליק -> קליק ימני (השינוי שלך)
                      onDoubleTap: () {
                        print("✌️ Double Tap -> Right Click");
                        _rightClick();
                      },
                  ...
                  GestureDetector(
                    behavior: HitTestBehavior.opaque,
                    onPanStart: (d) => _lastScrollPosition = d.localPosition,
